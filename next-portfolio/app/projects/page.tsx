  ...
  return (
    <>
      ...
      <Main className='w-xl flex flex-col'>
        ...
        <Paragraph>Some of them are represented in the images below and quite a lot of them are in this <Link href='https://github.com/f1ssure/Eensy-Web-Projects/tree/main'>repository</Link>.</Paragraph>
        <ImageSlider />
      </Main>
    </>
  );
